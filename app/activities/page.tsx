...
export default function ActivitiesPage() {
  // const [isSelectedCategory, setIsSelectedCategory] = useState<'adult' | 'senior' | 'wheelchair user'>
  ...
  return (
    ...
    >
      ...
      <iframe
        ...
        className="w-full h-4003"></iframe>
